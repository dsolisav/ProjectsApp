    ...
    <div>
      <div className="flex flex-row p-5 sm:py-10 sm:px-20 justify-between">
        <div className="flex flex-col w-full sm:w-[40%] justify-center">
          <p className="text-center sm:text-left text-6xl md:text-5xl lg:text-7xl xl:text-8xl font-bold mb-10 break-normal inline-block text-transparent bg-clip-text bg-gradient-to-br from-slate-950 to-slate-500 pb-3">
            Welcome to Designio!
          </p>
